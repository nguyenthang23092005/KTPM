...
<div class="max-w-4xl mx-auto bg-white rounded-lg shadow p-6">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">Thêm Nhân Viên Mới</h2>
    ...
    <form method="POST" action="{{ route('staff.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="border rounded-lg p-6 bg-gray-50">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="name" class="w-full p-2 border border-gray-300 rounded @error('name') border-red-500 @enderror" value="{{ old('name') }}" required>
                    @error('name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Ngày Sinh</label>
                    <input type="date" name="birth_date" class="w-full p-2 border border-gray-300 rounded @error('birth_date') border-red-500 @enderror" value="{{ old('birth_date') }}">
                ...
                <div>
                    ...
                    <input type="text" name="identity_card" class="w-full p-2 border border-gray-300 rounded @error('identity_card') border-red-500 @enderror" value="{{ old('identity_card') }}">
                ...
                <div>
                    ...
                    <select name="marital_status" class="w-full p-2 border border-gray-300 rounded">
                        <option value="">-- Chọn --</option>
                        <option value="Độc thân" {{ old('marital_status') == 'Độc thân' ? 'selected' : '' }}>Độc thân</option>
                        <option value="Đã kết hôn" {{ old('marital_status') == 'Đã kết hôn' ? 'selected' : '' }}>Đã kết hôn</option>
                        <option value="Ly hôn" {{ old('marital_status') == 'Ly hôn' ? 'selected' : '' }}>Ly hôn</option>
                    </select>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Quê Quán</label>
                    <input type="text" name="hometown" class="w-full p-2 border border-gray-300 rounded @error('hometown') border-red-500 @enderror" value="{{ old('hometown') }}">
                    @error('hometown') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email *</label>
                    <input type="email" name="email" class="w-full p-2 border border-gray-300 rounded @error('email') border-red-500 @enderror" value="{{ old('email') }}" required>
                    @error('email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Số Điện Thoại *</label>
                    <input type="tel" name="phone" class="w-full p-2 border border-gray-300 rounded @error('phone') border-red-500 @enderror" value="{{ old('phone') }}" required>
                    @error('phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>

                <div class="col-span-1">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Địa Chỉ Hiện Tại</label>
                    <input type="text" name="current_address" class="w-full p-2 border border-gray-300 rounded @error('current_address') border-red-500 @enderror" value="{{ old('current_address') }}">
                ...
                <div>
                    ...
                    <input type="text" name="ethnicity" class="w-full p-2 border border-gray-300 rounded @error('ethnicity') border-red-500 @enderror" value="{{ old('ethnicity') }}">
                ...
                <div>
                    ...
                    <input type="text" name="religion" class="w-full p-2 border border-gray-300 rounded @error('religion') border-red-500 @enderror" value="{{ old('religion') }}">
                ...
                <div>
                    ...
                    <input type="text" name="nationality" class="w-full p-2 border border-gray-300 rounded @error('nationality') border-red-500 @enderror" value="{{ old('nationality') }}">
        ...
        <div class="border rounded-lg p-6 bg-gray-50">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="position" class="w-full p-2 border border-gray-300 rounded @error('position') border-red-500 @enderror" value="{{ old('position') }}" required>
                ...
                <div>
                    ...
                    <select name="status" class="w-full p-2 border border-gray-300 rounded @error('status') border-red-500 @enderror" required>
                        ...
                        <option value="Tạm nghỉ" {{ old('status') == 'Tạm nghỉ' ? 'selected' : '' }}>Tạm nghỉ</option>
                        <option value="Nghỉ việc" {{ old('status') == 'Nghỉ việc' ? 'selected' : '' }}>Nghỉ việc</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="date" name="start_date" class="w-full p-2 border border-gray-300 rounded @error('start_date') border-red-500 @enderror" value="{{ old('start_date') }}">
                ...
                <div class="col-span-3">
                    ...
                    <textarea name="notes" rows="4" class="w-full p-2 border border-gray-300 rounded @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
        ...
        <div class="border rounded-lg p-6 bg-gray-50">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="education_level" class="w-full p-2 border border-gray-300 rounded @error('education_level') border-red-500 @enderror" placeholder="VD: Đại học, Cao đẳng..." value="{{ old('education_level') }}">
                ...
                <div>
                    ...
                    <input type="text" name="degree" class="w-full p-2 border border-gray-300 rounded @error('degree') border-red-500 @enderror" placeholder="VD: Cử nhân CNTT, Thạc sĩ..." value="{{ old('degree') }}">
                ...
                <div>
                    ...
                    <input type="text" name="school_name" class="w-full p-2 border border-gray-300 rounded @error('school_name') border-red-500 @enderror" placeholder="VD: Đại học Bách Khoa Hà Nội" value="{{ old('school_name') }}">
                ...
                <div class="col-span-3">
                    ...
                    <textarea name="certificates" rows="3" class="w-full p-2 border border-gray-300 rounded @error('certificates') border-red-500 @enderror" placeholder="VD: MOS, CCNA, PMP...">{{ old('certificates') }}</textarea>
                ...
                <div class="col-span-3">
                    ...
                    <textarea name="language_certificates" rows="3" class="w-full p-2 border border-gray-300 rounded @error('language_certificates') border-red-500 @enderror" placeholder="VD: TOEIC 750, IELTS 6.5, TOCFL B1...">{{ old('language_certificates') }}</textarea>
                ...
                <div class="col-span-3">
                    ...
                    <textarea name="previous_experience" rows="3" class="w-full p-2 border border-gray-300 rounded @error('previous_experience') border-red-500 @enderror" placeholder="Mô tả ngắn kinh nghiệm việc làm trước đây...">{{ old('previous_experience') }}</textarea>
        ...
        {{-- PASSWORD --}}
        <div class="border rounded-lg p-6 bg-gray-50">
            <h3 class="text-2xl font-bold text-black mb-4">Tài khoản đăng nhập</h3>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Mật Khẩu *</label>
                    <input type="password" name="password" class="w-full p-2 border border-gray-300 rounded @error('password') border-red-500 @enderror" required>
