            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    @if($employee->avatar_path)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $employee->avatar_path) }}" alt="avatar" class="w-20 h-20 rounded">
                        </div>
                    @endif
                ...
                <div>
                    ...
                    @if($employee->cv_path)
                        <div class="mb-2">
                            <a href="{{ asset('storage/' . $employee->cv_path) }}" target="_blank" class="text-blue-500 hover:underline">Xem CV</a>
                        </div>
                    @endif
                ...
                <div>
                    ...
                    @if($employee->contract_path)
                        <div class="mb-2">
                            <a href="{{ asset('storage/' . $employee->contract_path) }}" target="_blank" class="text-blue-500 hover:underline">Xem Hợp Đồng</a>
                        </div>
                    @endif
